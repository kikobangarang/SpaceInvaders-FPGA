...
-- Data[3]	=>  Location: PIN_B1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \R~0_combout\ = (!\Data[1]~input_o\ & (!\Data[2]~input_o\ & (\Data[3]~input_o\ & !\Data[0]~input_o\)))
